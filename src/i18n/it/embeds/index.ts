...
const it_embeds = {
	...
	about: {
		description:
			'{username} è un Discord bot intuitivo e facile da usare, conettato a https://paliapedia.com ed è stato creato da {developers}.',
	...
	item: {
		...
		teaches_recipe: 'Insegna la ricetta',
	...
	weekly_wants: {
		...
		description:
			'La lista dei regali settimanali graditi a {date} è ora disponibile! Puoi trovare la loro lista completa al {url}.',
	},
	miscellaneous: {
